...
<footer><div class="wrap">JFT Agro Overseas · Navi Mumbai, India · <a href="mailto:exports@jftagro.com">exports@jftagro.com</a> · <a href="tel:+918425057274">+91 84250 57274</a></div></footer>
<script>document.getElementById('localizedLead').addEventListener('submit',async function(e){{e.preventDefault();const b=this.querySelector('button');const s=this.querySelector('.form-status');b.disabled=true;try{{const data=Object.fromEntries(new FormData(this));data.lead_type='localized_quote';data.language='{lang}';data.subject='New {lang.upper()} Export Inquiry';await JFTConversion.submitLead(data);s.textContent={t['success']!r};this.reset();}}catch(_){{s.textContent='exports@jftagro.com · WhatsApp +91 84250 57274';}}finally{{b.disabled=false;}}}});</script>
</body></html>
'''
