(function () {
  ...
  function addEditorialReviewNote() {
    ...
    note.innerHTML = '<strong>Prepared by JFT Agro Trade Desk</strong><span>This buyer guidance is informational and does not represent a named human approval. Commercial and regulatory requirements can change; confirm the current rule with the destination authority and your licensed customs adviser before contracting.</span><span class="jft-source-links"><a href="https://apeda.gov.in/" target="_blank" rel="noopener noreferrer">APEDA</a><a href="https://www.dgft.gov.in/" target="_blank" rel="noopener noreferrer">DGFT</a><a href="https://fssai.gov.in/" target="_blank" rel="noopener noreferrer">FSSAI</a><a href="https://indianspices.com/" target="_blank" rel="noopener noreferrer">Spices Board India</a><a href="/editorial-policy.html">Editorial policy</a><a href="mailto:jftagro.info@gmail.com?subject=Editorial%20correction">Suggest a correction</a></span>';
